...
| --- | --- | --- |
| Windows, Node.js 24 | `npm run verify` on `windows-latest` | Local pre-commit run passed 777 tests, direct installed-hook execution, and packed-artifact checks on 2026-09-16; final candidate run pending |
